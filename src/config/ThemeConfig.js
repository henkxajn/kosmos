...
export const PRESET_THEMES = {
  ...
  // ── Neon Cyber — gorąca magenta, cyberpunkowy neon ──────────────

  neon_cyber: {
    bgPrimary:    '#08020a',
    bgSecondary:  '#0c0414',
    bgTertiary:   '#10061a',
    border:       'rgba(255,34,136,0.06)',
    borderLight:  'rgba(255,34,136,0.18)',
    borderActive: 'rgba(255,34,136,0.40)',
    textPrimary:  '#e0c8d8',
    textSecondary:'rgba(220,190,210,0.55)',
    textLabel:    'rgba(220,190,210,0.30)',
    textDim:      'rgba(220,190,210,0.25)',
    textHeader:   '#ff2288',
    accent:       '#ff2288',
    accentDim:    'rgba(255,34,136,0.08)',
    accentMed:    'rgba(255,34,136,0.15)',
    success:      '#44ffaa',
    successDim:   '#33cc88',
    danger:       '#ff4466',
    dangerDim:    '#cc2244',
    ...
    purple:       '#cc88ff',
    mint:         '#44ffaa',
    orbitLine:    'rgba(255,34,136,0.06)',
    orbitColony:  'rgba(255,34,136,0.20)',
    starfield:    '#e0c8d8',
    vignetteEnd:  'rgba(8,2,10,0.90)',
  ...
  ss_neon_cyber: {
    ...
    bgSecondary:  '#0c0414',
    bgTertiary:   '#10061a',
    border:       'rgba(255,34,136,0.09)',
    borderLight:  'rgba(255,34,136,0.19)',
    borderActive: '#ff2288',
    textPrimary:  '#e0c8d8',
    textSecondary:'rgba(255,34,136,0.67)',
    textLabel:    'rgba(255,34,136,0.38)',
    textDim:      'rgba(255,34,136,0.31)',
    textHeader:   '#ff2288',
    accent:       '#ff2288',
    accentDim:    'rgba(255,34,136,0.07)',
    accentMed:    'rgba(255,34,136,0.13)',
    success:      '#44ffaa',
    successDim:   '#33cc88',
    danger:       '#ff4466',
    dangerDim:    '#cc2244',
    ...
    mint:         '#44ffaa',
    orbitLine:    'rgba(255,34,136,0.06)',
    orbitColony:  'rgba(255,34,136,0.19)',
    starfield:    '#e0c8d8',
    vignetteEnd:  'rgba(8,2,10,0.88)',
    fontFamily:   "'Rajdhani', sans-serif",
    fontSizeTiny:   9,
    fontSizeSmall:  10,
    fontSizeNormal: 12,
