...
//   commodityCost: { structural_alloys: 2 } — towary z inventory
...
export const BUILDINGS = {
  ...
  mine: {
    ...
    cost:        { Fe: 20, C: 10 },
    commodityCost: { structural_alloys: 3, extraction_systems: 2, power_cells: 1 },
    energyCost:  2,
  ...
  solar_farm: {
    ...
    commodityCost: { structural_alloys: 4, power_cells: 3, conductor_bundles: 2 },
    energyCost:  0,
    buildTime:   1.0,      // lata gry (efektywnie ~30s przy 1d/s dzięki CIV_TIME_SCALE)
    rates:       { energy: 8 },
  ...
  coal_plant: {
    ...
    commodityCost: { structural_alloys: 5, conductor_bundles: 2 },
    energyCost:  0,
  ...
  geothermal: {
    ...
    cost:        { Fe: 30, Ti: 5 },
    commodityCost: { structural_alloys: 4, power_cells: 2, conductor_bundles: 1 },
    energyCost:  0,
    buildTime:   0.5,      // lata gry
    rates:       { energy: 25 },
  ...
  farm: {
    ...
    cost:        { Fe: 10, C: 5 },
    commodityCost: { structural_alloys: 2, polymer_composites: 1 },
    energyCost:  1,
    buildTime:   1.0,      // lata gry (efektywnie ~30s przy 1d/s dzięki CIV_TIME_SCALE)
    rates:       { food: 10 },
  ...
  well: {
    ...
    cost:        { Fe: 15 },
    commodityCost: { structural_alloys: 2, conductor_bundles: 1 },
    energyCost:  1,
    buildTime:   1.0,      // lata gry (efektywnie ~30s przy 1d/s dzięki CIV_TIME_SCALE)
    rates:       { water: 6 },
  ...
  habitat: {
    ...
    cost:        { Fe: 25, Si: 10 },
    commodityCost: { structural_alloys: 4, pressure_modules: 4, electronic_systems: 1 },
    energyCost:  3,
    buildTime:   1.0,      // lata gry (efektywnie ~30s przy 1d/s dzięki CIV_TIME_SCALE)
    rates:       {},
  ...
  research_station: {
    ...
    cost:        { Si: 20, Cu: 8 },
    commodityCost: { structural_alloys: 3, electronic_systems: 1 },
    energyCost:  6,
  ...
  factory: {
    ...
    commodityCost: { structural_alloys: 5, power_cells: 3, electronic_systems: 2 },
    energyCost:  5,
  ...
  smelter: {
    ...
    commodityCost: { structural_alloys: 5, power_cells: 3, extraction_systems: 2 },
    energyCost:  8,
  ...
  nuclear_plant: {
    ...
    commodityCost: { structural_alloys: 6, power_cells: 4, electronic_systems: 3, plasma_cores: 2 },
    energyCost:  0,
  ...
  shipyard: {
    ...
    commodityCost: { structural_alloys: 8, reactive_armor: 6, electronic_systems: 4, power_cells: 3, conductor_bundles: 2 },
    energyCost:  5,
  ...
  synthesized_food_plant: {
    ...
    commodityCost: { structural_alloys: 6, compact_bioreactor: 5, electronic_systems: 2, power_cells: 2 },
    energyCost:    8,
    buildTime:     0.5,     // lata gry
    rates:         { food: 6 },
  ...
  fusion_reactor: {
    ...
    cost:          { Ti: 40, Hv: 20, Li: 15, Fe: 20 },
    commodityCost: { structural_alloys: 6, plasma_cores: 4, conductor_bundles: 3 },
    energyCost:    0,
    buildTime:     1.5,     // lata gry
    rates:         { energy: 100 },
  ...
  terraformer: {
    ...
    cost:          { Ti: 50, Si: 30, Hv: 20, Fe: 30 },
    commodityCost: { structural_alloys: 6, metamaterials: 4, plasma_cores: 3, electronic_systems: 2 },
    energyCost:    20,
    buildTime:     1.5,     // lata gry
    rates:         {},
  ...
  observatory: {
    ...
    commodityCost: { structural_alloys: 4, electronic_systems: 3, power_cells: 2 },
    energyCost:    4,
    buildTime:     0.75,
    rates:         { research: 6 },
    maintenance:   { Si: 1 },
    ...
    scanInterval:      6.0,    // civYears na odkrycie na Lv1 (dzielone przez level)
  ...
  data_center: {
    ...
    commodityCost: { structural_alloys: 3, semiconductor_arrays: 2, conductor_bundles: 2 },
    energyCost:    6,
    buildTime:     0.5,
    rates:         { research: 3 },
  ...
  genetics_lab: {
    ...
    commodityCost: { structural_alloys: 4, electronic_systems: 3, compact_bioreactor: 1 },
    energyCost:    5,
    buildTime:     0.75,
    rates:         { research: 4 },
    maintenance:   { Cu: 1 },
  ...
  arcology_building: {
    ...
    commodityCost: { structural_alloys: 8, pressure_modules: 6, electronic_systems: 4 },
    energyCost:    10,
    buildTime:     1.5,
    rates:         { food: 5 },
    maintenance:   { Fe: 2, Cu: 1 },
  ...
  defense_tower: {
    ...
    commodityCost: { structural_alloys: 5, reactive_armor: 3, electronic_systems: 2 },
    energyCost:    4,
    buildTime:     1.0,
    rates:         {},
  ...
  defense_grid: {
    ...
    cost:          { Fe: 80, Ti: 40, Cu: 30, Hv: 15 },
    commodityCost: { structural_alloys: 10, reactive_armor: 8, electronic_systems: 6, metamaterials: 4 },
    energyCost:    20,
    buildTime:     2.0,
    rates:         {},
  ...
  antimatter_factory: {
    ...
    cost:          { Ti: 50, Hv: 50, Fe: 40 },
    commodityCost: { structural_alloys: 8, plasma_cores: 4, electronic_systems: 4, metamaterials: 3 },
    energyCost:    50,
    buildTime:     2.5,
    rates:         {},  // produkcja via FactorySystem
    maintenance:   { Ti: 2, Hv: 2 },
    housing:       0,
    popCost:       0.5,
    maxLevel:      3,
    capacityBonus: null,
  ...
  vacuum_generator: {
    ...
    cost:          { Ti: 80, Hv: 70, Fe: 60 },
    commodityCost: { plasma_cores: 6, quantum_processors: 4, metamaterials: 7 },
    energyCost:    0,
    buildTime:     3.0,
    rates:         { energy: 500 },
    maintenance:   { Ti: 3, Hv: 1 },
    housing:       0,
    popCost:       0.5,
    maxLevel:      3,
    capacityBonus: null,
  ...
  trade_hub: {
    ...
    commodityCost: { structural_alloys: 4, electronic_systems: 2, conductor_bundles: 2 },
    energyCost:    4,
    buildTime:     1.0,
    rates:         {},
    maintenance:   { Fe: 1 },
  ...
  free_market: {
    ...
    cost:          { Fe: 30, C: 15 },
    commodityCost: { structural_alloys: 5, electronic_systems: 1 },
    energyCost:    3,
    buildTime:     0.75,
    rates:         {},
    maintenance:   { Fe: 1 },
  ...
  trade_beacon: {
    ...
    cost:          { Ti: 10, Cu: 8 },
    commodityCost: { electronic_systems: 3, conductor_bundles: 4, power_cells: 2 },
    energyCost:    6,
    buildTime:     2.0,
    rates:         {},
  ...
  commodity_nexus: {
    ...
    cost:          { Ti: 20, Si: 15, Hv: 5 },
    commodityCost: { quantum_processors: 2, metamaterials: 1, electronic_systems: 3 },
    energyCost:    12,
    buildTime:     4.0,
    rates:         {},
    maintenance:   { Ti: 2, Hv: 1 },
    housing:       0,
    popCost:       0.5,
    maxLevel:      1,
    capacityBonus: null,
  ...
  warp_beacon: {
    ...
    cost:          { Fe: 500, Ti: 100, Hv: 50 },
    commodityCost: { metamaterials: 20, warp_cores: 5, quantum_processors: 4 },
    energyCost:    20,
    buildTime:     5.0,
    rates:         {},
    housing:       0,
  ...
  jump_gate: {
    ...
    cost:          { Fe: 2000, Ti: 400, Hv: 250 },
    commodityCost: { metamaterials: 40, quantum_processors: 15, warp_cores: 20 },
    energyCost:    50,
    buildTime:     15.0,
    rates:         {},
    housing:       0,
  ...
  robot_assembly: {
    ...
    commodityCost: { structural_alloys: 6, electronic_systems: 4 },
    energyCost:    8,
    buildTime:     2.0,
    rates:         {},
    maintenance:   { Fe: 2, Cu: 1 },
  ...
  android_lab: {
    ...
    commodityCost: { structural_alloys: 8, electronic_systems: 6, semiconductor_arrays: 4 },
    energyCost:    12,
    buildTime:     3.0,
    rates:         {},
    maintenance:   { Cu: 2, Si: 1 },
  ...
  ai_nexus: {
    ...
    cost:          { Ti: 100, Si: 80, Cu: 60, Hv: 20 },
    commodityCost: { semiconductor_arrays: 20, quantum_processors: 5, metamaterials: 3 },
    energyCost:    25,
    buildTime:     5.0,
    rates:         {},
    maintenance:   { Ti: 3, Hv: 1, Cu: 2 },
    housing:       0,
    popCost:       0,
    maxLevel:      1,
    capacityBonus: null,
  ...
  admin_office: {
    ...
    commodityCost: { structural_alloys: 3, electronic_systems: 2 },
    energyCost:    2,
    buildTime:     1.0,
    rates:         {},
    maintenance:   { Fe: 1 },
