...
const plMod = await import('./src/i18n/pl.js');
const enMod = await import('./src/i18n/en.js');
const { effectiveRange, canReach, isEnemyVessel } = await import('./src/entities/Vessel.js');
const { VesselManager } = await import('./src/systems/VesselManager.js');
const { GAME_CONFIG } = await import('./src/config/GameConfig.js');
const { CURRENT_VERSION } = await import('./src/systems/SaveMigration.js');
