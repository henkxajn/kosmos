...
import './src/testing/headless/env.js'; // MUST be first — shim window/document/THREE
...
import { EmpireResearchSystem } from './src/systems/EmpireResearchSystem.js';
import { ARCHETYPES } from './src/data/EmpireData.js';
