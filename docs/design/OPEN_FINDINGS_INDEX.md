...
| **210** | 🟡 | **WDROŻONE 2026-08-31, LIVE-GATE PENDING** (slice TARGET_FALLTHROUGH) — fall-through **w porządku wartości** (D-210-1 = A), trzy stany terminalne drabiny, `skippedHead` w `strikeLaunched`, (c) nie milczy. ⚠ Pomiar odrzucił re-sort po koszcie: dawał AI bijące **zawsze** w najsłabsze ciało | keeper `defense_scope_smoke` 69/69 (T19-T23) · ⚠ domyka się bez **202**, ale czyni 202 wiążącym (D-210-6) · `TARGET_FALLTHROUGH_PLAN.md` |
